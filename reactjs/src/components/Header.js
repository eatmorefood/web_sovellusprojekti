    ...
    <div className="header">
      <div className="headerContent">
          ...
          <div className="headerLeft">
              <img className="logoLarge" onClick={(e) => { e.preventDefault(); window.location.href='/'; }} src={logo} alt="EatMoreFood"></img>
          ...
          <div className="headerMiddle">
            <form role="search" className="headerSearchForm">
              <input className="searchInput" type="search" id="query" name="q" placeholder="Search..." autoComplete="off"/>
              <button>
          ...
          <div className="headerRight">
            <img className="userIcon" src={user} alt="" onClick={ displayLogin }/>
              <div className="btnDiv">
                  ...
                  <button className="signupBtnHeader" onClick={(e) => { e.preventDefault(); window.location.href='/signup'; }}><span>Register</span></button>
