    ...
    <div className="Login">
      ...
      <div className="loginContent">
        ...
        <form method="post" className="loginForm">
          <input type="email" className="loginEmail" name="email" placeholder="email" autoComplete="off"/>
          <input type="password" className="loginPassword" name="password" placeholder="password" autoComplete="off"/>
