...
const business={
    ...
    add: function(newBusiness, callback) {
          return db.query('with new_business as (insert into restaurant (name, address, open, type, pricelevel, image) values ($1, $2, $3, $4, $5, $8) returning idrestaurant as insertedrestaurantid) insert into userr (password, email, idrestaurant) select $6, $7, insertedrestaurantid from new_business returning idrestaurant;',
